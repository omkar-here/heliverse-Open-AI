...
import { AxiosPromise, AxiosInstance, AxiosRequestConfig } from 'openai/node_modules/axios';
import { RequestArgs, BaseAPI } from 'openai/dist/base';
/**
 *
 * @export
...
export declare class OpenAIApi extends BaseAPI {
     ...
     * @memberof OpenAIApi
     */
    cancelFineTune(fineTuneId: string, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<FineTune, any>>;
    /**
     *
     * @summary Answers the specified question using the provided documents and examples.  The endpoint first [searches](/docs/api-reference/searches) over provided documents or files to find relevant context. The relevant context is combined with the provided examples and question to create the prompt for [completion](/docs/api-reference/completions).
     * @param {CreateAnswerRequest} createAnswerRequest
     ...
     * @memberof OpenAIApi
     */
    createAnswer(createAnswerRequest: CreateAnswerRequest, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<CreateAnswerResponse, any>>;
    /**
     *
     * @summary Classifies the specified `query` using provided examples.  The endpoint first [searches](/docs/api-reference/searches) over the labeled examples to select the ones most relevant for the particular query. Then, the relevant examples are combined with the query to construct a prompt to produce the final label via the [completions](/docs/api-reference/completions) endpoint.  Labeled examples can be provided via an uploaded `file`, or explicitly listed in the request using the `examples` parameter for quick tests and small scale use cases.
     * @param {CreateClassificationRequest} createClassificationRequest
     ...
     * @memberof OpenAIApi
     */
    createClassification(createClassificationRequest: CreateClassificationRequest, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<CreateClassificationResponse, any>>;
    /**
     *
     * @summary Creates a completion for the provided prompt and parameters
     * @param {CreateCompletionRequest} createCompletionRequest
     ...
     * @memberof OpenAIApi
     */
    createCompletion(createCompletionRequest: CreateCompletionRequest, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<CreateCompletionResponse, any>>;
    /**
     *
     * @summary Creates a new edit for the provided input, instruction, and parameters
     * @param {CreateEditRequest} createEditRequest
     ...
     * @memberof OpenAIApi
     */
    createEdit(createEditRequest: CreateEditRequest, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<CreateEditResponse, any>>;
    /**
     *
     * @summary Creates an embedding vector representing the input text.
     * @param {CreateEmbeddingRequest} createEmbeddingRequest
     ...
     * @memberof OpenAIApi
     */
    createEmbedding(createEmbeddingRequest: CreateEmbeddingRequest, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<CreateEmbeddingResponse, any>>;
    /**
     *
     * @summary Upload a file that contains document(s) to be used across various endpoints/features. Currently, the size of all the files uploaded by one organization can be up to 1 GB. Please contact us if you need to increase the storage limit.
     * @param {File} file Name of the [JSON Lines](https://jsonlines.readthedocs.io/en/latest/) file to be uploaded.  If the &#x60;purpose&#x60; is set to \\\&quot;fine-tune\\\&quot;, each line is a JSON record with \\\&quot;prompt\\\&quot; and \\\&quot;completion\\\&quot; fields representing your [training examples](/docs/guides/fine-tuning/prepare-training-data).
     ...
     * @memberof OpenAIApi
     */
    createFile(file: File, purpose: string, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<OpenAIFile, any>>;
    /**
     *
     * @summary Creates a job that fine-tunes a specified model from a given dataset.  Response includes details of the enqueued job including job status and the name of the fine-tuned models once complete.  [Learn more about Fine-tuning](/docs/guides/fine-tuning)
     * @param {CreateFineTuneRequest} createFineTuneRequest
     ...
     * @memberof OpenAIApi
     */
    createFineTune(createFineTuneRequest: CreateFineTuneRequest, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<FineTune, any>>;
    /**
     *
     * @summary Creates an image given a prompt.
     * @param {CreateImageRequest} createImageRequest
     ...
     * @memberof OpenAIApi
     */
    createImage(createImageRequest: CreateImageRequest, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<ImagesResponse, any>>;
    /**
     *
     * @summary Creates an edited or extended image given an original image and a prompt.
     * @param {File} image The image to edit. Must be a valid PNG file, less than 4MB, and square.
     ...
     * @memberof OpenAIApi
     */
    createImageEdit(image: File, mask: File, prompt: string, n?: number, size?: string, responseFormat?: string, user?: string, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<ImagesResponse, any>>;
    /**
     *
     * @summary Creates a variation of a given image.
     * @param {File} image The image to use as the basis for the variation(s). Must be a valid PNG file, less than 4MB, and square.
     ...
     * @memberof OpenAIApi
     */
    createImageVariation(image: File, n?: number, size?: string, responseFormat?: string, user?: string, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<ImagesResponse, any>>;
    /**
     *
     * @summary Classifies if text violates OpenAI\'s Content Policy
     * @param {CreateModerationRequest} createModerationRequest
     ...
     * @memberof OpenAIApi
     */
    createModeration(createModerationRequest: CreateModerationRequest, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<CreateModerationResponse, any>>;
    /**
     *
     * @summary The search endpoint computes similarity scores between provided query and documents. Documents can be passed directly to the API if there are no more than 200 of them.  To go beyond the 200 document limit, documents can be processed offline and then used for efficient retrieval at query time. When `file` is set, the search endpoint searches over all the documents in the given file and returns up to the `max_rerank` number of documents. These documents will be returned along with their search scores.  The similarity score is a positive score that usually ranges from 0 to 300 (but can sometimes go higher), where a score above 200 usually means the document is semantically similar to the query.
     * @param {string} engineId The ID of the engine to use for this request.  You can select one of &#x60;ada&#x60;, &#x60;babbage&#x60;, &#x60;curie&#x60;, or &#x60;davinci&#x60;.
     ...
     * @memberof OpenAIApi
     */
    createSearch(engineId: string, createSearchRequest: CreateSearchRequest, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<CreateSearchResponse, any>>;
    /**
     *
     * @summary Delete a file.
     * @param {string} fileId The ID of the file to use for this request
     ...
     * @memberof OpenAIApi
     */
    deleteFile(fileId: string, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<DeleteFileResponse, any>>;
    /**
     *
     * @summary Delete a fine-tuned model. You must have the Owner role in your organization.
     * @param {string} model The model to delete
     ...
     * @memberof OpenAIApi
     */
    deleteModel(model: string, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<DeleteModelResponse, any>>;
    /**
     *
     * @summary Returns the contents of the specified file
     * @param {string} fileId The ID of the file to use for this request
     ...
     * @memberof OpenAIApi
     */
    downloadFile(fileId: string, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<string, any>>;
    /**
     *
     * @summary Lists the currently available (non-finetuned) models, and provides basic information about each one such as the owner and availability.
     * @param {*} [options] Override http request option.
     ...
     * @memberof OpenAIApi
     */
    listEngines(options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<ListEnginesResponse, any>>;
    /**
     *
     * @summary Returns a list of files that belong to the user\'s organization.
     * @param {*} [options] Override http request option.
     ...
     * @memberof OpenAIApi
     */
    listFiles(options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<ListFilesResponse, any>>;
    /**
     *
     * @summary Get fine-grained status updates for a fine-tune job.
     * @param {string} fineTuneId The ID of the fine-tune job to get events for.
     ...
     * @memberof OpenAIApi
     */
    listFineTuneEvents(fineTuneId: string, stream?: boolean, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<ListFineTuneEventsResponse, any>>;
    /**
     *
     * @summary List your organization\'s fine-tuning jobs
     * @param {*} [options] Override http request option.
     ...
     * @memberof OpenAIApi
     */
    listFineTunes(options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<ListFineTunesResponse, any>>;
    /**
     *
     * @summary Lists the currently available models, and provides basic information about each one such as the owner and availability.
     * @param {*} [options] Override http request option.
     ...
     * @memberof OpenAIApi
     */
    listModels(options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<ListModelsResponse, any>>;
    /**
     *
     * @summary Retrieves a model instance, providing basic information about it such as the owner and availability.
     * @param {string} engineId The ID of the engine to use for this request
     ...
     * @memberof OpenAIApi
     */
    retrieveEngine(engineId: string, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<Engine, any>>;
    /**
     *
     * @summary Returns information about a specific file.
     * @param {string} fileId The ID of the file to use for this request
     ...
     * @memberof OpenAIApi
     */
    retrieveFile(fileId: string, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<OpenAIFile, any>>;
    /**
     *
     * @summary Gets info about the fine-tune job.  [Learn more about Fine-tuning](/docs/guides/fine-tuning)
     * @param {string} fineTuneId The ID of the fine-tune job
     ...
     * @memberof OpenAIApi
     */
    retrieveFineTune(fineTuneId: string, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<FineTune, any>>;
    /**
     *
     * @summary Retrieves a model instance, providing basic information about the model such as the owner and permissioning.
     * @param {string} model The ID of the model to use for this request
     ...
     * @memberof OpenAIApi
     */
    retrieveModel(model: string, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<Model, any>>;
}
